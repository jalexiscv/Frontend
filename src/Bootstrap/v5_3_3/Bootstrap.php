...
class Bootstrap
{
    ...
    public static function tabs(array $options = []): TagInterface
    {
        return (new Tabs($options))->render();
    }
    ...
    /**
     * Crea un icono Font Awesome
     * 
     * Actúa como bypass/proxy a la clase Icon.
     * 
     * @param array $options Array de opciones (ver Icon::__construct)
     * @return TagInterface
     * 
     * @example
     * Bootstrap::icon(['icon' => 'rocket']);
     * Bootstrap::icon(['icon' => 'home', 'style' => 'solid', 'size' => '2xl']);
     */
    public static function icon(array $options = []): TagInterface
    {
        return (new Icon($options))->render();
    }

    public static function shortcuts(array $options = []): TagInterface
    {
        return (new Shortcuts($options))->render();
    }
     ...
     * Crea un indicador
     * 
     * Actúa como bypass/proxy a la clase Indicator.
     * 
     * @param array $options Array de opciones (ver Indicator::__construct)
     * @return TagInterface
     * 
     * @example
     * Bootstrap::indicator(['value' => '5', 'label' => 'Total', 'variant' => 'secondary']);
     */
    public static function indicator(array $options = []): TagInterface
    {
        return (new Indicator($options))->render();
    }

    /**
     * Crea una DataTable interactiva
     * 
     * Actúa como bypass/proxy a la clase DataTable.
     * 
     * @param array $options Array de opciones (ver DataTable::__construct)
     * @return TagInterface
     * 
     * @example
     * Bootstrap::dataTable(['columns' => [...], 'data' => [...], 'pagination' => true]);
     */
    public static function dataTable(array $options = []): TagInterface
    {
        return (new \Higgs\Frontend\Bootstrap\v5_3_3\Extras\DataTable($options))->render();
    }
}
