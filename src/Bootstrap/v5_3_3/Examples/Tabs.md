...
## Ejemplo 11: Content como Array (Opciones del Pane)
...
$tabs = new Tabs([
    'tabs' => [
        [
            ...
            'title' => 'Curso',
            'content' => [
                'htmlContent' => '<form>...formulario del curso...</form>',
                'class' => 'pt-3',
            ],
            'active' => true
        ],
        [
            ...
            'title' => 'Programa',
            'content' => [
                'htmlContent' => '<div class="p-2">Contenido del programa</div>',
                'class' => 'bg-light p-2',
            ],
        ],
        [
            ...
            'title' => 'Notas',
            'content' => [
                'content' => 'Texto plano escapado dentro del array',
                'class' => 'mt-2',
            ],
        ]
    ]
...
**Características:**
- `content` acepta un array con opciones para el `tab-pane`
- `class` dentro del array agrega clases CSS al div del pane
- `htmlContent` dentro del array renderiza HTML sin escapar
- `content` (string) dentro del array renderiza texto escapado
- Ideal para agregar padding, márgenes u otras clases al panel

---

## Ejemplo 12: paneClass (Clase del Pane en Formato Plano)
...
$tabs = new Tabs([
    'tabs' => [
        [
            'id' => 'tab1',
            'title' => 'Pestaña 1',
            'htmlContent' => '<p>Contenido con padding</p>',
            'paneClass' => 'pt-3 px-2',
            'active' => true
        ],
        [
            'id' => 'tab2',
            'title' => 'Pestaña 2',
            'htmlContent' => '<p>Otro contenido</p>',
            'paneClass' => 'p-4 bg-light'
        ]
    ]
]);
...
**Características:**
- `paneClass` agrega clases al div `tab-pane` sin usar el formato array
- Alternativa más simple cuando solo necesitas una clase extra
- Compatible con `htmlContent` y `content` string

---

## Ejemplo 13: Tabs con ID y Atributos Personalizados
...
**Características:**
- `id` personalizado para JavaScript (genera `#customTabs` y `#customTabsContent`)
- Atributos HTML adicionales en el contenedor
...
| `content` | string\|array | No | Contenido escapado (string) o array de opciones del pane |
...
| `class` | string | null | Clases CSS adicionales para el botón nav |
| `paneClass` | string | null | Clases CSS adicionales para el div tab-pane |

### Opciones de `content` como Array

Cuando `content` es un array, acepta las siguientes claves:

| Opción | Tipo | Descripción |
|--------|------|-------------|
| `htmlContent` | string | Contenido HTML sin escapar |
| `content` | string | Contenido texto escapado |
| `class` | string | Clases CSS para el div `tab-pane` |
